...
#  modified version of right_arm, cut down
...
class RightArmControl(object):
    def __init__(self, limb='right', hover_distance = 0.25, verbose=True, sequence=False):
        ...
        self._h_pass_angles = { 'right_s0': 0.16704773675001494,
                                'right_s1': -1.070536157253592,
                                'right_w0': 1.2793069313987573,
                                'right_w1': 1.494186105512508,
                                'right_w2': 0.6510857211494168,
                                'right_e0': 0.4939219022376884,
                                'right_e1': 2.0679031146659614}
    ...
    def pickbrick(self, calibrationpose=None, brick_y = 0.09, brick_z = 0.062):
    	...
    	brickpose.position.z = calibrationpose['position'].z - 0.9*brick_z
